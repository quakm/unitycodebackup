...
public class FloatingXPController : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 _spawnOffset = Vector3.up * 2f; // Offset über dem Spieler
    ...
    private Vector3 ConvertWorldToUIPosition(Vector3 worldPosition)
    {
        ...
        if (_uiCanvas.renderMode == RenderMode.ScreenSpaceCamera)
        {
            ...
            // Für Screen Space Camera müssen wir die Position anpassen
            ...
            // Konvertiere zurück zu World Position für das Canvas
