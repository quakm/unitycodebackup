...
public class TooltipController : MonoBehaviour
{
    ...
    public Vector2 minSize = new Vector2(100f, 40f); // Mindestgröße
    public Vector2 maxSize = new Vector2(400f, 200f); // Maximalgröße
    ...
    public void ShowTooltip(string text, Color color)
    {
        ...
        // Tooltip-Größe automatisch anpassen
        ResizeTooltip();
    ...
    public void UpdateTooltipPosition()
    {
        ...
        // Tooltip als RectTransform behandeln für UI-Positionierung
    ...
    private void ResizeTooltip()
    {
        ...
        // Erst den Text setzen, dann Größe berechnen
        tooltipText.text = tooltipText.text; // Stelle sicher, dass Text gesetzt ist

        // Force Update für sofortige Berechnung
        tooltipText.ForceMeshUpdate();

        // Textgröße direkt von TextMeshPro holen
        ...
        // Tooltip-Größe basierend auf Text + Padding
    ...
    // Die alte CalculateTextSize Methode wird nicht mehr benötigt für TextMeshPro
}